...
export function ProcuturaLogo({ size = "default", variant = "default" }: LogoProps) {
  const textSize = size === "large" ? "text-3xl" : "text-xl";
  const textColor = variant === "light" ? "text-white" : "text-navy-dark dark:text-white";
  ...
  return (
    <div className={`flex items-center gap-2 font-bold ${textSize}`}>
      ...
      >
        ...
        <path d="M10 11L6 18L10 25" stroke="#16a34a" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M26 11L30 18L26 25" stroke="#16a34a" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        <path
